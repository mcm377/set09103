...
artist_albums = {'Avicii': ['True'], 'Bugzy Malone': ['Walk With Me'], 'Calvin Harris': ['I Created Disco', 'Ready For The Weekend', '18 Months', 'Motion'], 'Clean Bandit': ['New Eyes', '2010', 'OriginL ClassC', 'Live fron France'], 'Drake': ['Thank Me Later', 'Take Care', 'Nothing Was The Same'], 'Eri Kitamura': ['Re;Story', u'Shomei (証×明; Proof)'], 'Gorgon City': ['Sirens'], 'Kano': ['Home Sweet Home', 'London Town', '140 Grime St', 'Method To The Meadness'], 'The Killers': ['Hot Fuss', 'Sam\'s Town', 'Day & Age'], 'Nero': ['Welcome Reality', 'Between II Worlds'], 'Rudimental': ['Home', 'We The Generation'], 'TRF': ['GRAVITY']}
